        ...
        <div
            ...
            {{ $activeTab > 1 || $this->isPostAvailable ? 'bg-emerald-500' : 'bg-gray-300 dark:bg-neutral-600' }}">
                ...
                <li class="flex items-center">
                    <button type="button"
                        @if (!$this->isPostAvailable && $activeTab < 2) disabled @else wire:click="setStep(2)" @endif
                ...
                <div class="flex flex-col">
                        ...
                        <div class="fixed inset-0 z-50 overflow-y-auto" aria-labelledby="modal-title" role="dialog"
                            ...
                            <div
                                ...
                                <div class="fixed inset-0 bg-gray-500 bg-opacity-75 transition-opacity"
                                    aria-hidden="true" wire:click="closeBulkEditModal"></div>

                                <!-- Modal panel -->
                                <div
                                    class="inline-block align-bottom bg-white dark:bg-neutral-800 rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-7xl sm:w-full">
                                    <div class="bg-white dark:bg-neutral-800 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                        ...
                                        <div
                                            ...
                                            <div
                                                class="px-2 py-3 bg-emerald-50 dark:bg-emerald-900/20 border-b-2 border-emerald-500 mb-2">
                                                <h3
                                                    class="text-sm font-semibold text-emerald-800 dark:text-emerald-200">
                                                    📝 Bulk Edit Form - Changes will apply to selected PRs
                                                </h3>
                                            </div>
                                                ...
                                                <table class="w-full text-xs min-w-max">
                                                    ...
                                                    <tbody>
                                                        <tr class="bg-white dark:bg-neutral-700">
                                                            ...
                                                            <td class="px-4 py-3">
                                                                <select
                                                                    wire:model.defer="bulkEdit.mode_of_procurement_id"
                                                            ...
                                                            @if ($showBiddingFields)
                                                                ...
                                                                <td class="px-4 py-3">
                                                                    <input type="text"
                                                                        wire:model="bulkEdit.bidding_number"
                                                                        maxlength="2"
                                                                ...
                                                                <td class="px-4 py-3">
                                                                    <input type="text"
                                                                        wire:model="bulkEdit.philgeps_posting_ref_no"
                                                                        class="w-full px-2 py-1 text-xs text-right border border-gray-300 dark:border-neutral-600 rounded focus:ring-2 focus:ring-emerald-500 dark:bg-neutral-800 dark:text-white disabled:opacity-60 disabled:cursor-not-allowed"
                                                                ...
                                                                <td class="px-4 py-3">
                                                                    <input type="date"
                                                                        wire:model="bulkEdit.ads_post_ib"
                                                                ...
                                                                <td class="px-4 py-3">
                                                                    <input type="date"
                                                                        wire:model="bulkEdit.pre_proc_conference"
                                                                        class="w-full px-2 py-1 text-xs border border-gray-300 rounded focus:ring-2 focus:ring-emerald-500 dark:bg-neutral-800 dark:text-white dark:border-neutral-600 disabled:opacity-60 disabled:cursor-not-allowed"
                                                                        @disabled($disableInputs)>
                                                                </td>
                                                                <!-- List of Invited Observers -->
                                                                ...
                                                                <td class="px-4 py-3">
                                                                    <input type="date"
                                                                        wire:model="bulkEdit.obsrvr_prebid_conf"
                                                                        class="w-full px-2 py-1 text-xs border border-gray-300 rounded focus:ring-2 focus:ring-emerald-500 dark:bg-neutral-800 dark:text-white dark:border-neutral-600 disabled:opacity-60 disabled:cursor-not-allowed"
                                                                        @disabled($disableInputs)>
                                                                </td>
                                                                <!-- Observers (Eligibility) -->
                                                                <td class="px-4 py-3">
                                                                    <input type="date"
                                                                        wire:model="bulkEdit.obsrvr_eligibility"
                                                                        class="w-full px-2 py-1 text-xs border border-gray-300 rounded focus:ring-2 focus:ring-emerald-500 dark:bg-neutral-800 dark:text-white dark:border-neutral-600 disabled:opacity-60 disabled:cursor-not-allowed"
                                                                        @disabled($disableInputs)>
                                                                </td>
                                                                <!-- Observers (Sub/Open) -->
                                                                <td class="px-4 py-3">
                                                                    <input type="date"
                                                                        wire:model="bulkEdit.obsrvr_sub_open_of_bid"
                                                                        class="w-full px-2 py-1 text-xs border border-gray-300 rounded focus:ring-2 focus:ring-emerald-500 dark:bg-neutral-800 dark:text-white dark:border-neutral-600 disabled:opacity-60 disabled:cursor-not-allowed"
                                                                        @disabled($disableInputs)>
                                                                </td>
                                                                <!-- Observers (Bid) -->
                                                                <td class="px-4 py-3">
                                                                    <input type="date"
                                                                        wire:model="bulkEdit.obsrvr_bid"
                                                                        class="w-full px-2 py-1 text-xs border border-gray-300 rounded focus:ring-2 focus:ring-emerald-500 dark:bg-neutral-800 dark:text-white dark:border-neutral-600 disabled:opacity-60 disabled:cursor-not-allowed"
                                                                        @disabled($disableInputs)>
                                                                </td>
                                                                <!-- Observers (Post Qual) -->
                                                                <td class="px-4 py-3">
                                                                    <input type="date"
                                                                        wire:model="bulkEdit.obsrvr_post_qual"
                                                                        class="w-full px-2 py-1 text-xs border border-gray-300 rounded focus:ring-2 focus:ring-emerald-500 dark:bg-neutral-800 dark:text-white dark:border-neutral-600 disabled:opacity-60 disabled:cursor-not-allowed"
                                                                        @disabled($disableInputs)>
                                                                </td>
                                                                <!-- Pre-Bid Conference -->
                                                                <td class="px-4 py-3">
                                                                    <input type="date"
                                                                        wire:model="bulkEdit.pre_bid_conf"
                                                                        class="w-full px-2 py-1 text-xs border border-gray-300 rounded focus:ring-2 focus:ring-emerald-500 dark:bg-neutral-800 dark:text-white dark:border-neutral-600 disabled:opacity-60 disabled:cursor-not-allowed"
                                                                        @disabled($disableInputs)>
                                                                </td>
                                                                <!-- Eligibility Check -->
                                                                <td class="px-4 py-3">
                                                                    <input type="date"
                                                                        wire:model="bulkEdit.eligibility_check"
                                                                        class="w-full px-2 py-1 text-xs border border-gray-300 rounded focus:ring-2 focus:ring-emerald-500 dark:bg-neutral-800 dark:text-white dark:border-neutral-600 disabled:opacity-60 disabled:cursor-not-allowed"
                                                                        @disabled($disableInputs)>
                                                                </td>
                                                                <!-- Sub/Open of Bids -->
                                                                <td class="px-4 py-3">
                                                                    <input type="date"
                                                                        wire:model="bulkEdit.sub_open_bids"
                                                                        class="w-full px-2 py-1 text-xs border border-gray-300 rounded focus:ring-2 focus:ring-emerald-500 dark:bg-neutral-800 dark:text-white dark:border-neutral-600 disabled:opacity-60 disabled:cursor-not-allowed"
                                                                        @disabled($disableInputs)>
                                                                </td>
                                                                <!-- Bid Evaluation Date -->
                                                                <td class="px-4 py-3">
                                                                    <input type="date"
                                                                        wire:model="bulkEdit.bid_evaluation_date"
                                                                        class="w-full px-2 py-1 text-xs border border-gray-300 rounded focus:ring-2 focus:ring-emerald-500 dark:bg-neutral-800 dark:text-white dark:border-neutral-600 disabled:opacity-60 disabled:cursor-not-allowed"
                                                                        @disabled($disableInputs)>
                                                                </td>
                                                                <!-- Post Qualification Date -->
                                                                <td class="px-4 py-3">
                                                                    <input type="date"
                                                                        wire:model="bulkEdit.post_qualification_date"
                                                                        class="w-full px-2 py-1 text-xs border border-gray-300 rounded focus:ring-2 focus:ring-emerald-500 dark:bg-neutral-800 dark:text-white dark:border-neutral-600 disabled:opacity-60 disabled:cursor-not-allowed"
                                                                        @disabled($disableInputs)>
                                                                </td>
                                                                <!-- Bidding Result -->
                                                                ...
                                                                <td class="px-4 py-3">
                                                                    <input type="text"
                                                                        wire:model="bulkEdit.resolution_number_mop"
                                                            ...
                                                            @elseif ($showSvpFields)
                                                                ...
                                                                <td class="px-4 py-3"></td> {{-- Bidding # --}}
                                                                <td class="px-4 py-3"></td> {{-- IB No. --}}
                                                                ...
                                                                @else
                                                                    <td class="px-4 py-3"></td> {{-- PhilGEPS (below 200k) --}}
                                                                    <td class="px-4 py-3"></td> {{-- Ads/Post IB (below 200k) --}}
                                                                @endif

                                                                <td class="px-4 py-3"></td> {{-- Pre-Proc Conference --}}
                                                                <td class="px-4 py-3"></td> {{-- List of Invited Observers --}}
                                                                <td class="px-4 py-3"></td> {{-- Observers (Pre-Bid) --}}
                                                                <td class="px-4 py-3"></td> {{-- Observers (Eligibility) --}}
                                                                <td class="px-4 py-3"></td> {{-- Observers (Sub/Open) --}}
                                                                <td class="px-4 py-3"></td> {{-- Observers (Bid) --}}
                                                                <td class="px-4 py-3"></td> {{-- Observers (Post Qual) --}}
                                                                <td class="px-4 py-3"></td> {{-- Pre-Bid Conference --}}
                                                                <td class="px-4 py-3"></td> {{-- Eligibility Check --}}
                                                                <td class="px-4 py-3"></td> {{-- Sub/Open of Bids --}}
                                                                <td class="px-4 py-3"></td> {{-- Bid Evaluation Date --}}
                                                                <td class="px-4 py-3"></td> {{-- Post Qualification Date --}}
                                                                <td class="px-4 py-3"></td> {{-- Bidding Result --}}
                                                                ...
                                                                <td class="px-4 py-3">
                                                                    <input type="date"
                                                                        wire:model="bulkEdit.canvass_date"
                                                                        class="w-full px-2 py-1 text-xs border border-gray-300 rounded focus:ring-2 focus:ring-emerald-500 dark:bg-neutral-800 dark:text-white dark:border-neutral-600 disabled:opacity-60 disabled:cursor-not-allowed"
                                                                        @disabled($disableInputs)>
                                                                </td>
                                                                <!-- Returned of Canvass -->
                                                                <td class="px-4 py-3">
                                                                    <input type="date"
                                                                        wire:model="bulkEdit.date_returned_of_canvass"
                                                                        class="w-full px-2 py-1 text-xs border border-gray-300 rounded focus:ring-2 focus:ring-emerald-500 dark:bg-neutral-800 dark:text-white dark:border-neutral-600 disabled:opacity-60 disabled:cursor-not-allowed"
                                                                        @disabled($disableInputs)>
                                                                </td>
                                                                <!-- Abstract of Canvass -->
                                                                <td class="px-4 py-3">
                                                                    <input type="date"
                                                                        wire:model="bulkEdit.abstract_of_canvass_date"
                                                                        class="w-full px-2 py-1 text-xs border border-gray-300 rounded focus:ring-2 focus:ring-emerald-500 dark:bg-neutral-800 dark:text-white dark:border-neutral-600 disabled:opacity-60 disabled:cursor-not-allowed"
                                                                        @disabled($disableInputs)>
                                                                </td>
                                                            @else
                                        ...
                                        <div
                                            ...
                                            <button type="button" wire:click="closeBulkEditModal"
                                                class="mt-3 w-full inline-flex justify-center rounded-md border border-gray-300 dark:border-gray-600 shadow-sm px-4 py-2 bg-white dark:bg-neutral-800 text-base font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-neutral-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm">
                                                Cancel
                                            </button>
                                        </div>
                                    </div>
                    ...
                    <div
                        ...
                        <div class="my-4">
                            ...
                            <div
                                class="px-2 py-3 bg-blue-50 dark:bg-blue-900/20 border-b-2 border-blue-500 mt-4 mb-2 flex justify-between items-center">
                                <h3 class="text-sm font-semibold text-blue-800 dark:text-blue-200">
                                    📋 Selected PRs
                                </h3>
                                <button type="button" wire:click="openBulkEditModal"
                                    class="px-4 py-2 bg-emerald-600 text-white text-sm font-medium rounded-lg hover:bg-emerald-700 focus:ring-2 focus:ring-emerald-500 transition-colors duration-200">
                                    Bulk Edit
                                </button>
                            </div>
                        </div>
                    ...
                    <div
                        ...
                        <div class="overflow-x-auto max-h-[600px] overflow-y-auto">
                            ...
                            <div class="my-4">
                                <div class="h-px bg-gray-300 dark:bg-neutral-600"></div>
                                <div
                                    class="px-2 py-3 bg-blue-50 dark:bg-blue-900/20 border-b-2 border-blue-500 mt-4 mb-2">
                                    <h3 class="text-sm font-semibold text-blue-800 dark:text-blue-200">
