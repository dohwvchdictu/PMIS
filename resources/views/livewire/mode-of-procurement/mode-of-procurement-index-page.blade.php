<div
    ...
    <div class="sticky top-0 z-40 bg-white dark:bg-neutral-800 border-b border-gray-200 dark:border-neutral-700 w-full"
        ...
        <div x-show="showFilters" x-transition:enter="transition ease-out duration-200"
            ...
            <div class="px-6 py-4">
                <div class="grid grid-cols-1 md:grid-cols-7 lg:grid-cols-8 gap-3">
            ...
            <tbody class="bg-white dark:bg-neutral-800">
                @foreach ($procurements as $procurement)
                    ...
                    <tr
                        ...
                        <td
                            class="px-1 py-4 text-center sticky left-0 z-20 {{ $loop->even ? 'bg-gray-50 dark:bg-neutral-900' : 'bg-white dark:bg-neutral-800' }} group-hover:bg-gradient-to-r group-hover:from-emerald-50 group-hover:to-teal-50 dark:group-hover:from-emerald-900/20 dark:group-hover:to-teal-900/20 text-black dark:text-white w-20">
                        ...
                        @php
                            ...
                            $isSuccessful = strtoupper($status) === 'SUCCESSFUL';
                                            ...
                                            @forelse($paginatedItems as $item)
                                                <tr
                                                    ...
                                                    @php
                                                        ...
                                                        $isItemSuccessful = strtoupper($itemStatus) === 'SUCCESSFUL';
                                                    ...
                                                    <td
                                                        ...
                                                        @if ($item->currentStatus)
                                                            <span
                                                                class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium border {{ $itemStatusColor }}">
                                                                {{ $item->currentStatus }}
                                                            </span>
                                                        @else
                                                            <span
                                                                class="text-gray-400 dark:text-gray-500 text-xs italic">Pending</span>
                                                        @endif
                                                    </td>
                                                    <td
