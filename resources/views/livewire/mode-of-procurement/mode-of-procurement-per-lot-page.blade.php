        ...
        <div class="absolute top-0 left-0 z-10">
            @can('view_procurement')
                <a href="{{ route('procurements.view', ['procurement' => $procurement->procID]) }}" target="_blank"
                    class="inline-flex items-center px-3 py-1.5 rounded-tl-xl rounded-br-xl text-s font-semibold bg-emerald-600 text-white shadow-md hover:bg-emerald-700 transition-colors">
                    ...
                    <div
                        ...
                        <div class="flex items-center justify-between gap-4">
                            ...
                            @else
                                ...
                                <div class="flex-shrink-0" x-data="{ showTip: false, tipX: 0, tipY: 0 }"
                                    @mouseenter="
                                    ...
                                    <button type="button" disabled
                                        class="flex items-center gap-2 px-4 py-2 text-sm font-medium text-gray-400 bg-gray-100 dark:bg-neutral-700 dark:text-neutral-400 border border-gray-300 dark:border-neutral-600 rounded-lg cursor-not-allowed select-none">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" fill="none"
                                            viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    ...
                                    <template x-teleport="body">
                                        <div x-show="showTip" x-cloak
                                            ...
                                            <p class="font-semibold mb-1">Complete all required fields to forward:</p>
