<div>
    ...
    <div class="mb-6">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Edit PMU Record</h1>
                <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Update existing PMU record</p>
            </div>
