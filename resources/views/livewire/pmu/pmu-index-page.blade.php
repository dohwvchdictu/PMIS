            ...
            <div
                ...
                <div
                    ...
                    <button wire:click="confirmReceive" wire:loading.attr="disabled"
                        ...
                        <svg wire:loading wire:target="confirmReceive" class="w-4 h-4 animate-spin" fill="none"
                            viewBox="0 0 24 24">
        ...
        <div class="px-4 py-3">
            ...
            <div
                ...
                <p class="text-sm text-emerald-900 dark:text-emerald-100">
                    <span class="font-semibold">{{ count($selectedNoaNumbers) }}</span> NOA(s) selected for receipt.
                </p>
            </div>
                ...
                <div
                    ...
                    @foreach ($selectedNoaNumbers as $noa)
                        <div class="flex items-center justify-between px-3 py-2">
                            <span class="text-sm font-medium text-gray-900 dark:text-white">{{ $noa }}</span>
            ...
            <div class="mb-4">
                ...
                @error('bulkReceiveDate')
                    <p class="mt-1 text-xs text-red-600 dark:text-red-400">{{ $message }}</p>
                @enderror
                <p class="mt-1 text-xs text-gray-400 dark:text-gray-500">This date will be applied to all selected NOA
                    numbers.</p>
            </div>
