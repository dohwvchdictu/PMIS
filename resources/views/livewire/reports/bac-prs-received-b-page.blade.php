                ...
                @forelse ($procurements as $procurement)
                    @if ($procurement->procurement_type === 'perLot')
                        ...
                        <tr
                            ...
                            <td class="px-3 py-4 text-center text-sm text-gray-700 dark:text-gray-200">
                                @if ($pmuPo?->po_date)
                                    <span class="text-xs">{{ \Carbon\Carbon::parse($pmuPo->po_date)->format('M d, Y') }}</span>
                                @else
                                    <span class="text-gray-400 italic text-xs">N/A</span>
                                @endif
                            </td>
                            ...
                            <td class="px-3 py-4 text-center text-sm text-gray-700 dark:text-gray-200">
                                @if ($pmuPo?->contract_signing_date)
                                    <span class="text-xs">{{ \Carbon\Carbon::parse($pmuPo->contract_signing_date)->format('M d, Y') }}</span>
                                @else
                                    <span class="text-gray-400 italic text-xs">N/A</span>
                                @endif
                            </td>
                            ...
                            <td class="px-3 py-4 text-center text-sm text-gray-700 dark:text-gray-200">
                                @if ($pmuPo?->notice_to_proceed_date)
                                    <span class="text-xs">{{ \Carbon\Carbon::parse($pmuPo->notice_to_proceed_date)->format('M d, Y') }}</span>
                                @else
                                    <span class="text-gray-400 italic text-xs">N/A</span>
                                @endif
                            </td>
                            ...
                            <td class="px-3 py-4 text-center text-sm text-gray-700 dark:text-gray-200">
                                @if ($pmuPo?->forwarded_to_supply_at)
                                    <span class="text-xs">{{ \Carbon\Carbon::parse($pmuPo->forwarded_to_supply_at)->format('M d, Y') }}</span>
                                @else
                                    <span class="text-gray-400 italic text-xs">N/A</span>
                                @endif
                            </td>
                    ...
                    @else
                        @foreach ($procurement->pr_items as $item)
                            <tr
                                ...
                                @php $pmuPo = $itemPmuPoMap->get($item->prItemID); @endphp
