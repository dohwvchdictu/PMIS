            ...
            <div class="flex items-end justify-between gap-3">
                ...
                <div class="flex-shrink-0">
                    ...
                    <button type="button" title="Export to Excel"
                        class="inline-flex items-center justify-center w-10 h-10 bg-emerald-600 hover:bg-emerald-700 text-white rounded-lg transition-colors duration-200 shadow-sm hover:shadow-md dark:bg-emerald-600 dark:hover:bg-emerald-700">
